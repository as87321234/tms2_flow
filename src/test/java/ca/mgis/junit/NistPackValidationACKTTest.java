...
@SpringBootTest(classes = NistPackValidationACKTTest.class)
public class NistPackValidationACKTTest {
	
	Logger log = LoggerFactory.getLogger(NistPackValidationACKTTest.class);
	
	private String transactionType = "ACKT";
...
//		ansiNistPacket.validate();
	...
	public void tag_2_8910() throws Exception {
		...
		Assertions.assertTrue(validator.validateFieldLength(transactionType, tag, fieldIdKey, subfieldIdKey, itemIdKey, buildString(3,' ' )));
		Assertions.assertFalse(validator.validateFieldLength(transactionType, tag, fieldIdKey, subfieldIdKey, itemIdKey, buildString(4,' ' )));
